...
if __FILE__ == $0
  ...
  FlexMate::BundleTool.class_template_search(['ActionScript3', 'Flex']).each { |t|
  ...
  class BundleToolTest < Test::Unit::TestCase
    ...
    def test_find_without_extension
      ...
      assert_equal("#{user_app_sup}/TextMate/Bundles/ActionScript3.tmbundle", FlexMate::BundleTool.find_bundle('ActionScript3'))
    end
    ...
    def test_find_with_extension
      ...
      assert_equal("#{user_app_sup}/TextMate/Bundles/ActionScript3.tmbundle", FlexMate::BundleTool.find_bundle('ActionScript3.tmbundle'))      
    end
